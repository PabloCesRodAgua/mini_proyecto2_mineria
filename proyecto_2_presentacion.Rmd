...
students_dataset_norm$Utilizacion_de_transporte_publico <- factor(students_dataset_norm$Utilizacion_de_transporte_publico, levels = c(1, 0), labels = c("Si", "No"))
print(prop.table(table(students_dataset_norm$Utilizacion_de_transporte_publico))*100, digits=1)
```
